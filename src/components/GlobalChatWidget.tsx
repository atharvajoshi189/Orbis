            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="mb-4 w-[400px] h-[600px] max-h-[80vh] shadow-2xl rounded-2xl overflow-hidden border border-slate-200 dark:border-white/10 bg-white dark:bg-[#0a0f1e] transition-colors"
                    >
