...
export default function Footer() {
    return (
        <footer className="border-t border-slate-200 dark:border-white/10 bg-slate-50/80 dark:bg-black/40 backdrop-blur-xl py-16 transition-colors duration-300 relative z-10">
