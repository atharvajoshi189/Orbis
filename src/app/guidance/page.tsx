            ...
            <main className="container-custom mx-auto pt-32 pb-12 px-4 relative z-10 min-h-[calc(100vh-80px)]">
                ...
                {step === 0 && (
                    ...
                    >
                        <div className="text-center mb-20">
                            <h2 className="text-4xl md:text-7xl font-black mb-8 tracking-tighter leading-[0.9] font-outfit">
                                Select <span className="text-cyan-400 drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">Guidance</span>, <br />
                                <span className="text-white/90">Protocol.</span>
                            </h2>
                            <p className="text-slate-400 text-xl md:text-2xl font-medium max-w-3xl mx-auto leading-relaxed border-l-2 border-primary/30 pl-6 ml-auto mr-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-3xl font-black mb-4">Neural AI Avatar</h3>
                            ...
                            <motion.div
                                ...
                                className="group relative bg-[#0a0514]/80 border border-purple-500/10 p-12 rounded-[3rem] cursor-pointer hover:border-purple-500/50 transition-all overflow-hidden"
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-3xl font-black mb-4">Human-AI Strategic Partner</h3>
                                    <p className="text-slate-400 leading-relaxed mb-10 text-lg">
                ...
                {step === 1 && (
                    ...
                    >
                        <button
                            onClick={() => setStep(0)}
                            className="mb-8 text-slate-500 hover:text-white text-xs font-bold uppercase tracking-widest flex items-center gap-2 transition-colors"
                        >
                        ...
                        <div className="bg-slate-900/40 border border-white/5 rounded-[2.5rem] p-10 backdrop-blur-3xl shadow-2xl relative overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />

                            <div className="border-2 border-dashed border-slate-700 rounded-3xl p-16 text-center hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 group/upload cursor-pointer relative">
                                <input
                                    type="file" multiple
                                    className="absolute inset-0 opacity-0 cursor-pointer z-20"
                                    onChange={handleFileUpload}
                                />
                                <div className="w-24 h-24 bg-slate-800/80 rounded-[2rem] flex items-center justify-center mx-auto mb-8 group-hover/upload:scale-110 group-hover/upload:rotate-6 transition-transform duration-500 shadow-xl border border-white/5">
                                    <Upload className="w-10 h-10 text-primary" />
                                </div>
                                <h3 className="text-2xl font-bold text-white mb-3">Upload Academic Payload</h3>
                                    ...
                                    >
                                        {documents.map((doc, i) => (
                                            <div key={i} className="flex items-center gap-4 bg-white/5 p-4 rounded-xl border border-white/5">
                                                ...
                                                <span className="text-sm font-bold flex-1 truncate">{doc.name}</span>
                ...
                {step === 2 && profile && (
                    <div className="flex flex-col h-[calc(100vh-280px)] min-h-[700px] mt-8 border border-white/10 rounded-[2.5rem] bg-[#0a0f1d]/80 backdrop-blur-3xl overflow-hidden shadow-[0_0_150px_rgba(0,0,0,0.6)] animate-in zoom-in-95 duration-500">

                        {/* --- TOP HUD --- */}
                        <div className="flex items-center justify-between px-12 py-8 border-b border-white/5 bg-black/30">
                            <div className="flex items-center gap-8">
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black text-primary uppercase tracking-[0.2em]">Guidance Vector</span>
                                    <span className="text-2xl font-black text-white italic">{mode === 'HUMAN' ? 'HUMAN-AI HYBRID' : 'NEURAL AI AVATAR'}</span>
                                </div>
                                <div className="h-10 w-[1px] bg-white/10" />
                                <div className="flex flex-col">
                                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Subject Identity</span>
                                    <span className="text-sm font-bold text-white uppercase">{profile.personal.name || "UNIDENTIFIED"}</span>
                                </div>
                            </div>
                            ...
                            <div className="flex bg-black/50 p-1.5 rounded-2xl border border-white/10">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-3 px-8 py-4 rounded-xl text-[10px] font-black transition-all ${activeView === tab.id
                        ...
                        <div className="flex-1 flex overflow-hidden">
                            ...
                            <div className="flex-1 p-12 overflow-y-auto relative bg-gradient-to-br from-transparent to-primary/5 scroll-smooth">
                                <AnimatePresence mode="wait">
                                    ...
                                    >
                                        {activeView === 'GLOBAL' && (
                                            <div className="space-y-10">
                                                <div className="flex justify-between items-end border-b border-white/10 pb-8">
                                                    <h2 className="text-5xl font-black tracking-tighter uppercase font-outfit">
                                                        Geo-Strategic <span className="text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.3)]">Targets</span>
                                                    </h2>
                                                    <div className="bg-black/60 px-5 py-3 rounded-2xl border border-white/10 flex items-center gap-5">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                    {globalOps.map((op, i) => (
                                                        <div key={i} className="bg-[#111827] border border-white/5 p-10 rounded-[2.5rem] relative group hover:border-primary/50 transition-all overflow-hidden">
                                                            <Globe className="absolute -top-10 -right-10 w-48 h-48 opacity-5 group-hover:scale-125 transition-transform duration-700" />
                                                            <div className="relative z-10">
                                                                <div className="flex justify-between items-start mb-8">
                                                                    <span className="px-4 py-1.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] font-black uppercase">{op.country}</span>
                                                                    <div className="text-3xl font-black text-white">{op.probability + (ieltsSim > 7 ? 5 : 0)}%</div>
                                                                </div>
                                                                <h3 className="text-2xl font-black mb-2">{op.university}</h3>
                                                                <p className="text-slate-500 mb-8">{op.program}</p>
                                                                <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-6">
                                                                    <div className="text-[10px] font-bold text-slate-400 uppercase">Cost: {op.tuition}</div>
                                                                    <div className="text-[10px] font-bold text-green-400 uppercase">ROI: VERY HIGH</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ))}
                                        ...
                                        {activeView === 'CAREER' && (
                                            <div className="space-y-10">
                                                <h2 className="text-5xl font-black tracking-tighter border-b border-white/10 pb-8 uppercase font-outfit">
                                                    Work <span className="text-purple-400 drop-shadow-[0_0_10px_rgba(168,85,247,0.3)]">Vectors</span>
                                                </h2>
                                                <div className="space-y-6">
                                                    {careerPaths.map((path, i) => (
                                                        <div key={i} className="flex gap-10 bg-[#111827] border border-white/5 p-10 rounded-[2.5rem] hover:bg-black/40 transition-all group">
                                                            ...
                                                            <div className="flex-1">
                                                                <div className="flex justify-between items-start mb-4">
                                                                    ...
                                                                    <div className="text-right">
                                                                        <div className="text-[8px] font-black text-slate-500 uppercase">Outlook</div>
                                                                        <div className="text-green-400 font-black tracking-widest text-lg">{path.jobOutlook}</div>
                                                                    </div>
                                                                </div>
                                                                <p className="text-slate-400 text-sm mb-8 leading-relaxed max-w-2xl">{path.description}</p>
                                                                <div className="flex flex-wrap gap-2">
                                                                    {path.skillsGap.map(s => (
                                                                        <span key={s} className="px-4 py-2 rounded-xl bg-black/50 border border-white/10 text-[10px] font-bold text-slate-400 uppercase tracking-widest">{s}</span>
                                                                    ))}
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        {activeView === 'MISSION' && (
                                            <div className="max-w-4xl mx-auto space-y-16">
                                                ...
                                                <div className="relative">
                                                    <div className="absolute left-[39px] top-6 bottom-6 w-[2px] bg-gradient-to-b from-primary via-primary/30 to-transparent" />
                                                    <div className="space-y-14">
                                                        {timeline.map((step, i) => (
                                                            <div key={i} className="flex gap-12 items-start relative z-10">
                                                                <div className={`w-20 h-20 rounded-[2rem] flex items-center justify-center shrink-0 border-2 ${step.status === 'Completed' ? 'bg-green-500/10 border-green-500 text-green-500' :
                                                                    step.status === 'Active' ? 'bg-primary/20 border-primary text-primary animate-pulse' :
                                                                        'bg-[#111827] border-white/10 text-slate-600'
                                                                    }`}>
                                                                    <span className="font-black text-xl italic">{step.month}</span>
                                                                </div>
                                                                <div className="flex-1 pt-4">
                                                                    <h4 className={`text-2xl font-black mb-1 ${step.status === 'Active' ? 'text-primary' : 'text-white'}`}>{step.title}</h4>
                            ...
                            {/* RIGHT LOGS */}
                            <div className="w-80 border-l border-white/5 p-8 flex flex-col gap-8 bg-black/20 shrink-0">
                                <div className="flex-1 flex flex-col min-h-0">
                                    <h4 className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-4 flex items-center gap-2">
                                        <div className="w-2 h-2 rounded-full bg-primary animate-pulse" /> Neural Logs
                                    </h4>
                                    <div className="flex-1 bg-black/60 border border-white/10 rounded-2xl p-6 font-mono text-[9px] text-primary/80 overflow-y-auto space-y-3 custom-scrollbar">
                                        {aiLogs.map((log, i) => (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-red-950/20 border border-red-500/30 p-6 rounded-[2rem]">
                                        <div className="flex justify-between items-center mb-4">
                                            <span className="text-[10px] font-black text-red-500 uppercase">Risk Level</span>
                                            <span className="text-[8px] font-black text-red-400 bg-red-400/10 px-2 py-0.5 rounded border border-red-500/50">MODERATE</span>
                                        </div>
                                        <ul className="space-y-2">
                                            {intelligence?.riskAnalysis.factors.map((f, i) => (
                                                <li key={i} className="text-[10px] text-red-200/60 leading-tight">• {f}</li>
                                            ))}
                                        </ul>
                                    </div>
                                </div>

                                <button onClick={() => setStep(0)} className="w-full py-5 rounded-2xl border border-white/10 text-[10px] font-black text-slate-500 hover:text-white hover:bg-white/5 transition-all uppercase tracking-[0.2em]">
                                    Terminate Session
                                </button>
                            </div>
                        </div>
                ...
                {step === 3 && (
                    ...
                    >
                        <button
                            onClick={() => setStep(0)}
                            className="mb-12 text-slate-500 hover:text-white text-xs font-bold uppercase tracking-widest flex items-center gap-2 transition-colors"
                        >
                            <ChevronRight className="w-4 h-4 rotate-180" /> Back to Selection
                        </button>

                        <div className="text-center mb-16">
                            <h2 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter font-outfit uppercase">
                                Upgrade Your <span className="text-purple-400 drop-shadow-[0_0_15px_rgba(168,85,247,0.4)]">Intelligence</span>
                            </h2>
                            <p className="text-slate-400 text-lg max-w-2xl mx-auto">Choose an elite tier to unlock human-led global strategy and mission roadmaps.</p>
                        </div>
...
function PricingCard({
    ...
    return (
        <motion.div
            whileHover={{ y: -5 }}
            className={`p-10 rounded-[2.5rem] border transition-all flex flex-col ${highlighted
        ...
        >
            ...
            <h3 className="text-2xl font-black mb-1 font-outfit uppercase">{title}</h3>
            <div className="flex items-baseline gap-1 mb-4">
                <span className="text-xl font-bold text-slate-500">$</span>
                <span className="text-5xl font-black font-outfit">{price}</span>
                <span className="text-[10px] text-slate-500 uppercase font-bold ml-1">/ mo</span>
            </div>
            <p className="text-xs text-slate-400 mb-8 leading-relaxed font-medium">{description}</p>

            <div className="space-y-4 mb-10 flex-1">
                {features.map((f, i) => (
                    <div key={i} className="flex gap-3 text-[11px] text-slate-300 font-medium">
            ...
            <button
                ...
                className={`w-full py-4 rounded-2xl text-xs font-black uppercase tracking-[0.15em] transition-all ${isCurrent
                    ...
                    : highlighted
                        ? 'bg-purple-500 text-white shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 hover:scale-[1.02]'
